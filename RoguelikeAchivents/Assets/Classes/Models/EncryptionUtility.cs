...
{
    private static readonly string key = "1234567890abcdef"; //Clave de 128 bits(16 caracteres)
    private static readonly string iv = "abcdef9876543210"; // Vector de inicialización de 128 bits


    // Método para encriptar una cadena usando AES
    public static string Encrypt(string plainText)
        ...
        // Método para desencriptar una cadena usando AES
